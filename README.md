...
**SWAPI Explorer GUI** es una aplicación desarrollada en **Java Swing** que permite consultar información del universo de **Star Wars** usando la [Star Wars API (SWAPI)](https://swapi.dev/).  
